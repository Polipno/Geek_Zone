    ...
    <div class="bordure-texte">
      ...
      <div class="responsive-video">
        <iframe
          width="1080"
          height="630"
          src="https://www.youtube.com/embed/YKRI_q2ZbiA?si=gaLP42gNkY3D-yIY"
  ...
  <section id="CaptureEcran">
    <div class="bordure-texte">
      ...
      <div class="image-gallery">
        <img
          src="../../assets/Lets_Play/A_Highland_Song/Image_1_A_Highland_Song.jpeg"
          alt="A Highland Song : Moira escalade une paroi rocheuse au petit matin, les collines s'étendent en contrebas"
          class="Image"
          loading="lazy"
        />
        <br />
        <img
          src="../../assets/Lets_Play/A_Highland_Song/Image_2_A_Highland_Song.jpeg"
          alt="A Highland Song : Moira court sur une crête aux côtés d'une biche pendant une séquence rythmée, des notes de musique flottent autour d'elle"
          class="Image"
          loading="lazy"
        />
        <br />
        <img
          src="../../assets/Lets_Play/A_Highland_Song/Image_3_A_Highland_Song.jpeg"
          alt="A Highland Song : Moira, lampe frontale allumée, discute sous terre avec un homme en combinaison et casque de mineur assis sur un rocher"
          class="Image"
          loading="lazy"
        />
        <br />
        <img
          src="../../assets/Lets_Play/A_Highland_Song/Image_4_A_Highland_Song.jpeg"
          alt="A Highland Song : Moira court sous une pluie battante dans la brume, une biche l'observe au loin"
          class="Image"
          loading="lazy"
        />
      </div>
...
<script>
export default {
  name: 'LetsPlayAHighlandSongComponent',
};
</script>
