  ...
  <section id="Histoire">
    <div class="bordure-texte">
      ...
      <p>
        ...
        <strong>16</strong> ans, est invitée à un camping par son <strong>père</strong>, qu'elle n'a
        pas revu depuis <strong>6 mois</strong> en raison de ses obligations professionnelles.
        <br />
        Durant son séjour au camping, <strong>Ashley</strong> se trouve impliquée dans les tumultes
        d'un groupe d'adolescents, y compris aider un garçon en fuite. <br />
        Elle se lance également dans une quête personnelle pour déterrer les souvenirs oubliés de sa
        <strong>mère</strong> et percer le secret de <strong>l'Another</strong>. <br />
