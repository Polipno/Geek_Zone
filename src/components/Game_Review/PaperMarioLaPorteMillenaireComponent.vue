<template>
  ...
  <section id="Information">
    <div class="bordure-texte">
      <h2>Information</h2>
      <p>
        Développé par Intelligent Systems, Paper Mario: La Porte Millénaire
        sorti sur GameCube en 2004 est revenu en remake le 23 mai 2024.
      </p>
    </div>
  </section>
  <section id="Histoire">
    <div class="bordure-texte">
      <h2>Histoire</h2>
      <p>
        L'histoire commence lorsque Mario reçoit une lettre de Peach,
        accompagnée d'une carte au trésor, lui demandant de la rejoindre à
        Port-Lacanaïe. <br />
        À son arrivée, Mario découvre que Peach a disparu. <br />
        En enquêtant, il apprend que Peach a été enlevée par un groupe connu
        sous le nom de la <strong>Société X-Naut</strong>. <br />
        Pour sauver Peach et résoudre le mystère, Mario doit trouver sept
        <strong>Cristaux Étoiles</strong>. <br />
        Ces cristaux sont nécessaires pour ouvrir la
        <strong>Porte Millénaire</strong>, une porte ancienne qui est censée
        renfermer un trésor légendaire.
      </p>
    </div>
  </section>
  <section id="MonRessenti">
    <div class="bordure-texte">
      ...
      <p>
        ...
        <strong>transformations</strong> de Mario
        <strong>sympathiques</strong> qui offriront leur lot de divertissement
        très bien sans oublier la bande-son très sympa. <br /><br />
...
<script>
export default {
  name: "PaperMarioLaPorteMillenaireComponent",
};
</script>
