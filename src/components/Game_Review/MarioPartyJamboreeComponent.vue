    ...
    <div class="bordure-texte">
      ...
      <div class="image-gallery">
        <img
          ...
          alt="Image 1 de Mario Party Jamboree"
          class="Image"
        />
        <br />
        <img
          src="../../assets/Mario_Party_Jamboree/Image_2_Super_Mario_Party_Jamboree.jpg"
          alt="Image 2 de Mario Party Jamboree"
          class="Image"
        />
        <br />
        <img
          src="../../assets/Mario_Party_Jamboree/Image_3_Super_Mario_Party_Jamboree.jpg"
          alt="Image 3 de Mario Party Jamboree"
          class="Image"
        />
        <br />
        <img
          src="../../assets/Mario_Party_Jamboree/Image_4_Super_Mario_Party_Jamboree.jpg"
          alt="Image 4 de Mario Party Jamboree"
          class="Image"
        />
      </div>
    </div>
