<template>
  ...
  <section id="Information">
    <div class="bordure-texte">
      <h2>Information</h2>
      <p>
        Mario Kart World est un jeu de course dévloppé par Nintendo, sorti le 5
        juin 2025 exclusivement sur Nintendo Switch 2.
      </p>
    </div>
  </section>
  <section id="Mon ressentit">
    <div class="bordure-texte">
      <h2>Mon ressentit</h2>
      <p>
        Visuellement, ce jeu est une vraie réussite, il est très beau et tourne
        parfaitement sur la Nintendo Switch 2.<br />
        Le jeu propose 32 circuits disponibles au le lancement, jouables en solo
        ou à plusieurs, en local comme en ligne.<br />
        Le gameplay est très fun, et l’ajout de nouvelles mécaniques comme le
        Charge Jump ou la fonction Rewind apporte un vent de fraîcheur à la
        saga.<br />
        ...
        propres règle.<br />
        Le mode Balade permet quant à lui d’explorer un open world, à la
        recherche de collectibles comme des P-Switch, des médailles Peach, ou
        encore des panneaux.<br />
        D'autres modes comme le Contre-la-montre ou le Mode Combat offrent une
        expérience alternative chouette.<br />
        Au total, 50 personnages jouables sont disponibles, accompagnés de 103
        skins (sans compter les skins de base), ainsi que 40 véhicules au moment
        de la sortie.<br />
