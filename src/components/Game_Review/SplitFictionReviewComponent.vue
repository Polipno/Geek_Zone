<template>
  <div class="review-container">
    ...
    <ul>
      ...
      <li><strong>Développeur :</strong> Fictional Games Studio</li>
      <li><strong>Date de sortie :</strong> 2025</li>
      <li><strong>Plateformes :</strong> PC, Switch, PlayStation, Xbox</li>
    </ul>
    <h2>Notre avis</h2>
    <p>
