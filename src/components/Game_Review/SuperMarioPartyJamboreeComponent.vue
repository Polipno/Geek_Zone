<template>
  <div class="bordure-image mobile-only">
    <img
      src="../../assets/Super_Mario_Party_Jamboree/Affiche_Super_Mario_Party_Jamboree.jpeg"
      alt="Affiche de Super Mario Party Jamboree"
      class="Image"
    />
  </div>
  ...
  <section id="CaptureEcran">
    <div class="bordure-texte">
      ...
      <div class="image-gallery">
        <img
          src="../../assets/Super_Mario_Party_Jamboree/Image_1_Super_Mario_Party_Jamboree.jpeg"
          alt="Super Mario Party Jamboree : Luigi dans la nacelle d'une montgolfière rouge et blanche au-dessus d'une place aux fontaines"
          class="Image"
          loading="lazy"
        />
        <br />
        <img
          src="../../assets/Super_Mario_Party_Jamboree/Image_2_Super_Mario_Party_Jamboree.jpeg"
          alt="Super Mario Party Jamboree : mini-jeu où Luigi, Waluigi, Koopa et Maskass frappent au marteau face à des rangées de Thwomps"
          class="Image"
          loading="lazy"
        />
        <br />
        <img
          src="../../assets/Super_Mario_Party_Jamboree/Image_3_Super_Mario_Party_Jamboree.jpeg"
          alt="Super Mario Party Jamboree : Donkey Kong et Wario perchés sur des blocs ? dans un mini-jeu, Luigi les observe derrière une vitre"
          class="Image"
          loading="lazy"
        />
        <br />
        <img
          src="../../assets/Super_Mario_Party_Jamboree/Image_4_Super_Mario_Party_Jamboree.jpeg"
          alt="Super Mario Party Jamboree : Luigi, Waluigi, un Goomba et Wario miniatures courent devant un plateau géant de burgers et de frites"
          class="Image"
          loading="lazy"
        />
      </div>
...
<script>
export default {
  name: 'SuperMarioPartyJamboreeComponent',
};
</script>
