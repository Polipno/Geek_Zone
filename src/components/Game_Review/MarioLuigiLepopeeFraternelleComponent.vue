<template>
  ...
  <section id="Information">
    <div class="bordure-texte">
      <h2>Information</h2>
      <p>
        Mario & Luigi : L'Épopée fraternelle est un jeu de rôle développé par Acquire et édité par
        Nintendo, sorti sur Nintendo Switch le 7 novembre 2024. <br />
        Ce nouvel opus marque le retour de la célèbre série après la faillite du studio AlphaDream,
  ...
  <section id="Histoire">
    <div class="bordure-texte">
      <h2>Histoire</h2>
      <p>
        Un beau jour, près du château de la princesse Peach, Mario et Luigi sont aspirés dans un
        vortex apparu de nulle part, les menant dans un monde inconnu.<br />
        Les deux frères y font une rencontre avec Amperia et se retrouvent à explorer des îles pour
        sauver ce monde qu’ils découvriront peu à peu, tout en cherchant un moyen de rentrer chez
        eux.
      </p>
    </div>
  </section>
  <section id="MonRessenti">
    <div class="bordure-texte">
      ...
      <p>
        ...
        Bien que le jeu soit destiné à un public jeune, je le recommande à tous les fans de la série
        pour plonger dans cette aventure remplie d'émotion et d'humour.
      </p>
    </div>
  </section>
